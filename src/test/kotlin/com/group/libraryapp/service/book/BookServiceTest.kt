...
class BookServiceTest @Autowired constructor(
    ...
    fun loanBookTest() {
        ...
        val savedUser = userRepository.save(User("책좋아", null))
        val request = BookLoanRequest("책좋아", "이상한 나라의 앨리스")
    ...
    @Test
    @DisplayName("책이 진작 대출되어 있따면, 신규 대출이 실패한다.")
    ...
    fun returnBookTest() {
        ...
        val savedUser = userRepository.save(User("책좋아", null))
        userLoanHistoryRepository.save(UserLoanHistory.fixture(savedUser, "이상한 나라의 앨리스"))
        val request = BookReturnRequest("책좋아", "이상한 나라의 앨리스")
    ...
    fun countLoanedBookTest() {
        // given
        val savedUser = userRepository.save(User("책최고", null))
